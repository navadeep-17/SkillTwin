      ...
      <div className="grid gap-6 md:grid-cols-[1.2fr_.8fr] md:items-center">
        <div>
          ...
          <p className="mt-3 text-slate-600">
            SkillTwin selects an assessable target using your latest role gaps, evidence confidence, and the available validated question bank. Challenges can include MCQs, short answers, and scenarios when the bank supports them.
          </p>
